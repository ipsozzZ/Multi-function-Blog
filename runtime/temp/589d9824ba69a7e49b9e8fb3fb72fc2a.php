<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"/home/ftp/1/1975386453/ipso/public/../application/index/view/news/index.html";i:1542904234;s:67:"/home/ftp/1/1975386453/ipso/application/index/view/common/menu.html";i:1541252774;s:69:"/home/ftp/1/1975386453/ipso/application/index/view/common/footer.html";i:1544256018;}*/ ?>
<!DOCTYPE html>
<head id="Head">
...
<div id="wrapper" class="insi-page">
    ...
    <!--banner-->
    <div id="a1portalSkin_headerAreaA" class="header"><a name="31861" id="31861"></a>
        <div class="module-default">
            <div class="module-inner">
                <div id="a1portalSkin_ctr107142107142_mainArea" class="module-content">
                    <div class="slideshow slideshow-min carousel clearfix" style="height:450px; overflow:hidden;">
                        <div id="carousel-107142">
                            <div class="carousel-item">
                                <div class="carousel-img"><a href="javascript:;" target><img
                                        src="/<?php echo getbannerpic($currid); ?>" height="450" alt="banner"/></a></div>
                            </div>
                        </div>
                        <div class="carousel-btn carousel-btn-fixed" id="carousel-page-107142"></div>
                    </div>
                    <script type="text/javascript">
                        $(window).bind("load resize", function () {
                            $("#carousel-107142").carouFredSel({
                                width: '100%',
                                items: {visible: 1},
                                auto: {pauseOnHover: true, timeoutDuration: 5000},
                                swipe: {onTouch: true, onMouse: true},
                                pagination: "#carousel-page-107142",
                                scroll: {fx: "crossfade"}
                            });
                        });
                    </script>
    ...
    <section class="main">
        <div class="page-width clearfix">
            <section class="content float-right">
                ...
                <div id="a1portalSkin_mainArea" class="content-wrapper"><a name="31828" id="31828"></a>
                    <div class="module-default">
                        <div class="module-inner">
                            <div id="a1portalSkin_ctr107141107141_mainArea" class="module-content">
                                <div class="entry-list entry-list-article entry-list-mobile">
                                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                    <div class="entry-item">
                                        <div class="typo">
                                            <div class="typo-img">
                                                <div class="entry-img"><a href="<?php echo url('index/news/show',['id'=>$vo['id']]); ?>" target="_blank"><img
                                                        src="/<?php echo $vo['pic']; ?>" width="220" height="140"
                                                        alt="<?php echo $vo['title']; ?>"/></a></div>
                                            </div>
                                            <div class="typo-text">
                                                <div class="entry-title">
                                                    <h2><a href="<?php echo url('index/news/show',['id'=>$vo['id']]); ?>" target="_blank"><?php echo $vo['title']; ?></a></h2>
                                                </div>
                                                <div class="news-info" style="font-size:.95em;color:#AAA;">
                                                    <span>作者：<?php echo $vo['author']; ?></span><span>发布时间：<?php echo date("Y/m/d",$vo['addtime']); ?></span><span>浏览次数：<?php echo $vo['views']; ?>次</span>
                                                    <span>点赞次数：<?php echo $vo['fabul']; ?>次</span>
                                                    <span>评论次数：<?php echo $vo['comment']; ?>次</span>
                                                </div>
