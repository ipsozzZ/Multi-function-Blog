<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:79:"/home/ftp/1/1975386453/ipso/public/../application/index/view/contact/index.html";i:1541252774;s:67:"/home/ftp/1/1975386453/ipso/application/index/view/common/menu.html";i:1541252774;s:69:"/home/ftp/1/1975386453/ipso/application/index/view/common/footer.html";i:1544256018;}*/ ?>
<!DOCTYPE html>
<head id="Head">
                        ...
                        <div class="module-inner">
                            <div id="a1portalSkin_ctr107144107144_mainArea" class="module-content">
                                <div class="qhd-content">
                                    <p>
                                        <span style="font-size:22px;"><?php echo $top_child['name']; ?></span></p>
                                    <p> 电话：<?php echo $config['phone']; ?><br/>
                                        Q Q：<?php echo $config['online']; ?><br/>
                                        邮箱：<a href="mailto:<?php echo $config['mail']; ?>"><?php echo $config['mail']; ?></a><br/>
                                        地址：<?php echo $config['address']; ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div id="a1portalSkin_ctr107137107137_mainArea" class="module-hlbg-content">
                                <div class="category category-107137 article-category">
                                    <ul>
                                        ...
                                        <li {eq name="vo.id" value="$currid" }class="current" {
                                        /eq}><a href="<?php echo makeurl($vo['type'],$vo['id']); ?>"><?php echo $vo['name']; ?></a><i></i></li>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </ul>
                                </div>
                                <script type="text/javascript">
