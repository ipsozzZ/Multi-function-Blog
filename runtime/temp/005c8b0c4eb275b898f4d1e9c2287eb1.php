<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:79:"/home/ftp/1/1975386453/ipso/public/../application/index/view/pictures/show.html";i:1541252774;s:67:"/home/ftp/1/1975386453/ipso/application/index/view/common/menu.html";i:1541252774;s:69:"/home/ftp/1/1975386453/ipso/application/index/view/common/footer.html";i:1544256018;}*/ ?>
<!DOCTYPE html>
<head id="Head">
                    ...
                    <div class="slideshow slideshow-min carousel clearfix" style="height:450px; overflow:hidden;">
                        <div id="carousel-107135">
                            <div class="carousel-item">
                                <div class="carousel-img"><a href="javascript:;" target><img src="/<?php echo getbannerpic($currid); ?>"
                                                                                             height="450"
                                                                                             alt="banner"/></a></div>
                            </div>
                        </div>
                        ...
                        <div class="module-inner">
                            <div id="a1portalSkin_ctr107133107133_mainArea" class="module-content">
                                <div class="article-detail">
                                    <img style="width: 700px; height: 500px" src="/<?php echo $article['pic']; ?>" alt="ipso">
                                </div>
                            </div>
                        </div>
                    </div>
